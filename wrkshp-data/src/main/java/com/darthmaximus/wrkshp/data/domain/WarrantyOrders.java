...
@Entity
public class WarrantyOrders extends Orders {
	...
	private Set<WarrantyOrdersEntries> warrantyOrderEntries = new LinkedHashSet<>();
	...
	public Set<WarrantyOrdersEntries> getWarrantyOrderEntries() {
		return warrantyOrderEntries;
	}
	public void setWarrantyOrderEntries(Set<WarrantyOrdersEntries> warrantyOrderEntries) {
		this.warrantyOrderEntries = warrantyOrderEntries;
	}
	@Override
	public String toString() {
		final int maxLen = 10;
		StringBuilder builder = new StringBuilder();
		builder.append("WarrantyOrder [subTotal=").append(subTotal).append(", serviceTax=").append(serviceTax)
				...
				.append(serviceCompletedDate).append(", remarks=").append(remarks).append(", warrantyOrderEntries=")
				.append(warrantyOrderEntries != null ? toString(warrantyOrderEntries, maxLen) : null)
